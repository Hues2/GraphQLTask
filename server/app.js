...
async function getData(input){
    input = userInput
    await axios.get("https://www.greenbowsports.co.uk/graphql?query={products(search: " + input + "){items {name short_description {html} id sku image {url} price {regularPrice{ amount {value currency}}}}}}")
    .then(response => {
